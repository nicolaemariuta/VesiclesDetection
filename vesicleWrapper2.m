...
%runs
average = sum(statisticEnergy)/size(vesicleClicks,1);
averageEnergy = [deviation average; averageEnergy];
...
% figure;
% hold on;plot(averageEnergy(:,1),averageEnergy(:,2)); hold off;
% xlabel('deviation'), ylabel('energy');
% drawnow;
